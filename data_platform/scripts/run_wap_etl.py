...
import os
import logging
from data_platform.etl.batch_postgres_minio_wap_etl import (
    BatchPostgresMinioWriteAuditPublishETL,
)
...
ELT_TABLES = [
    "staging_parking_violation_codes",
    "staging_parking_violations_issued"
]
